...
export async function aprobarDocumento(_documentoId: string) {
...
export async function rechazarDocumento(_documentoId: string, _motivo: string) {
...
export async function crearUsuario(_data: {
  email: string;
  nombre?: string;
...
export async function updateUsuarioRol(
  _userId: string,
  _rol: "admin" | "director_equipo" | "jugador",
) {
...
export async function toggleUsuarioActivo(_userId: string, _activo: boolean) {
