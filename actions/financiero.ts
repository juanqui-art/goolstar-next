...
export async function getTransaccionesByEquipo(equipoId: string) {
...
export async function marcarPagado(transaccionId: string) {
  // 1. Call Supabase: UPDATE transacciones_pago SET pagado = true
  // 2. Return: updated transaction
  throw new Error("Not implemented yet")
}

export async function getEquipoBalance(equipoId: string) {
